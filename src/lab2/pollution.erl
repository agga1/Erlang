...
%% arguments:    addValue(Monitor, Id,  Date, Type, Value)
...
removeValue([], _, _, _) ->  throw("incorrect measurement data");
...
%% GET ONE VALUE ------------------------------------------------------------------------------
% for fetching value of measurement with given Date and Type
% arguments: (Monitor, StationId, Date, Type)
...
% returns {highest average for an hour , hours in which it occurred }
